 ...
 * parseInt 두 번째 인수에는 사용할 진법을 표시한다.
 */
parseInt('012', 10); 
...
// 문제: 배열 fruits를 사용해 콘솔에 Cherry를 출력해 봅시다.
...
// 이름을 입력하면 "안녕하세요, 김태곤 님"과 같이 출력하는 함수 hello를 선언하라.
function hello(name) {
...
// 변수의 스코프(scope) = 유효범위
// var 변수 = 10;
// 호이스팅(hoisting) : 함수나 변수가 마치 함수를 가장 처음 실행할 때 선언된 것처럼 다룰 수 있는 성질
function 함수() {
	var 변수 = 1;
	변수 = 변수 + 1;
...
// 문제: 배열 마지막 원소의 값을 반환하는 arrayFirst() 함수를 작성하라.
